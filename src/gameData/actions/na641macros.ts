...
export const macrosWorkshopActions: { [key: string]: Action } = {
  ...
  narcadia_macros_pay_charger: {
    ...
    postComplete: [
      ...
      COMPLETION_EFFECTS.addLog(
        "A bit confused with offered device, Macro was able to figure out how to add a battery slot there. 'Batteries are 1 coin a pop, by the way', he informed you"
      ),
    ],
  },
  ...
  narcadia_macros_observe_work: {
    ...
    postComplete: [
      COMPLETION_EFFECTS.addLog(
        "Macro is finished with repairing some old watch, replacing a battery, and goes back to reading a newspaper"
      ),
    ],
  },
